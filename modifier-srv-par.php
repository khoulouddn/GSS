...
$requete8=$bdd->prepare('UPDATE `serveur` SET `idserveur`=?,`nom`=?,`IP`=?, `DNS`=? ,`etat`=? ,`localisation`=? ,`passerelle`=? ,
  `dernieremodification`=? ,`dureegarantie`=? ,`serveur dapplications_idserveur`=?,
...
$requete8->execute(array($_POST['id'],$_POST['nom'],$_POST['ip'],$_POST['dns'],$_POST['etat'],$_POST['loc'],$_POST['pas'],
  $_POST['der'],$_POST['gar'],'',$_POST['id'],$id));
...
<body>
     ...
     if (strcmp( $_SESSION['type'], "Admin") == 0) {
      echo '<li style="margin-right:3px;"><a href="liste-serveurs-par.php" class="fa fa-angle-left" title="Précédent" ></a></li>';
...
<div class="col-md-4">    
 ...
 <div class="col-md-4">                             
          ...
          <h4 style="font-size:20px;color:white;text-align: center;"><i><b>modifier le Serveur</b></i></h4>
        </div>
