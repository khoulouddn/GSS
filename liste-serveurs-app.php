...
if (mysqli_num_rows($rs)<=0) {
  if (strcmp( $_POST['etatap'], "connecté") == 0) {$h="sac.png";}else{$h="san.png";}
 ...
 $requete=$bdd->prepare('INSERT INTO `serveur`( `idserveur`,`nom`,`IP`,`DNS`,`etat`,`localisation`,`passerelle`,
  ...
  VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)');
 $requete->execute(array($_POST['idap'],$_POST['nomap'],$_POST['ipap'],$_POST['dnsap'],$_POST['etatap'],$_POST['empap'],$_POST['pasap'],$_POST['map'],$_POST['gap'],'Application',$h,$_POST['idap'],''));
...
$requt=$bdd->prepare('INSERT INTO `serveur dapplications`( `idserveur`) VALUES (?)');
...
<body>
      ...
      if (strcmp( $_SESSION['type'], "User") == 0) {
          ...
          echo '<li style="margin-right:3px;"><a href="interfaceuser.php" class="fa fa-home" title="Accueil" ></a></li>';
            }
...
<div style="text-align: center; color: #2b3856;"> 
  <b style="font-size:40px;"> SERVEURS D'APPLICATION</b></div>
                                           <div class="row">
                                              <div class="col-md-12">
...
$bdd= new PDO("mysql:host=localhost;dbname=gss;charset=utf8","root","");
$conn = mysqli_connect("localhost", "root", "", "gss"); 
$query = "SELECT * FROM `serveur` Join`caracteristiques`  WHERE `idserveur` LIKE `serveur dapplications_idserveur` AND 
...
echo' <td> <a href="cara-app.php?caraa='.$row['idserveur'].'"class ="btn btn-default" ><i>caracteristiques</i></td>';
echo' <td> <a href="grp-app.php?adminaa='.$row['idserveur'].'"class ="btn btn-default"><i>groupe</i></td>'; 
echo' <td> <a href="liste-app.php?a='.$row['idserveur'].'"class ="btn btn-default" ><i>applications</i></td>';                      
echo'<td> <a href="serveur-app-rel.php?srv='.$row['idserveur'].'"class ="btn btn-default"><i>serveurs reliés</i></td>';
echo'<td> <a href="page - schema.php?s='.$row['idserveur'].'"class ="btn btn-default"><i class="fa fa-desktop" ></i></td>';
 if (strcmp( $_SESSION['type'], "Admin") == 0) {
 echo '<td> <a href="modifier-srv-app.php?modsa='.$row['idserveur'].'"> 
